...
{
    [self RequestWithType:HttpRequestTypeGet URLString:URLString parameters:parameters success:^(NSDictionary *response) {
        if (success) {
            success(response);
        }
...
{
    [self RequestWithType:HttpRequestTypePost URLString:URLString parameters:parameters success:^(NSDictionary *response) {
        if (success) {
            success(response);
        }
    } failure:^(NSError *error) {
